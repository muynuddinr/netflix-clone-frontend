const Footer = () => {
  const footerLinks = [
    ...
    {
      links: ["Media Center", "Terms of Use", "Contact Us", "Netflix Shop"]
    }
  ];

  return (
    <footer className="bg-black text-[#737373] px-4 md:px-16 py-8 mt-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {footerLinks.map((section, index) => (
            <div key={index}>
              {section.title && (
                <h3 className="text-sm mb-4">{section.title}</h3>
              )}
        ...
        {/* Language Selector */}
        <div className="mt-8">
          <button className="border border-[#737373] rounded px-4 py-1 flex items-center gap-2 hover:border-white group">
            ...
            <span className="text-sm group-hover:text-white">English</span>
          </button>
        </div>
